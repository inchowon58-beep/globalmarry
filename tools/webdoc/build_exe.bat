...
python -m PyInstaller --noconfirm --clean --windowed --name "국제결혼정보원웹문서생성기" ^
...
echo.
echo 완료: dist\국제결혼정보원웹문서생성기\국제결혼정보원웹문서생성기.exe
echo.
echo 실행 방법:
echo   1) 국제결혼정보원_웹문서생성기_실행.bat 더블클릭
echo   2) 또는 dist\국제결혼정보원웹문서생성기\국제결혼정보원웹문서생성기.exe
echo.
