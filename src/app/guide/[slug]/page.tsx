...
import { SITE, absoluteUrl, guidePageUrl } from "@/lib/site";
...
import AgencyBanner from "@/app/components/AgencyBanner";
import {
...
export default async function GuidePage({ params }: Props) {
  ...
  const articleLd = {
    ...
    about: ["국제결혼", "국제결혼절차", "정식등록업체", page.keyword],
  };
  ...
  return (
    <article className="pb-8 pt-8 md:pt-10">
      ...
      <div className="bg-[linear-gradient(180deg,#0e2238_0%,#16324f_42%,#f7f5f1_42%)] px-4 pb-10 pt-6">
      ...
      <div className="container max-w-3xl py-12">
        ...
        <p className="mb-2 text-sm font-bold tracking-wide text-[var(--teal)]">
          {page.heroSubtitle}
        </p>
        <h1 className="mb-8 text-lg font-semibold leading-snug text-[var(--navy)] md:text-xl">
          {page.h1}
        </h1>
        ...
        <div className="guide-prose">
          {page.sections.map((sec, si) => (
            <section key={sec.h2} className="mb-12">
              ...
              <div className="my-3 h-px w-12 bg-[var(--gold)]" />
        ...
        <AgencyBanner regionLabel={cityLabel || page.keyword} />
      </div>
    </article>
  );
}
