...
export default function NearbyRegionsSection({
  ...
  return (
    <section className="mb-12 rounded-2xl border border-[var(--line)] bg-gradient-to-br from-[#e8f1ff]/50 to-white p-6 shadow-[0_8px_24px_rgba(28,36,52,0.04)] sm:p-8">
      ...
      <p className="mt-3 text-sm leading-relaxed text-[var(--muted)]">
        {cityLabel}에서 {keywordSuffix}을 알아보는 분들이 상담·서류 준비 범위로 함께 검색하는 근방 구·동입니다.
      </p>
