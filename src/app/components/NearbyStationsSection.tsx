...
export default function NearbyStationsSection({
  ...
  return (
    <section className="mb-12 rounded-2xl border border-[var(--line)] bg-gradient-to-br from-[#fff0eb]/40 to-white p-6 shadow-[0_8px_24px_rgba(28,36,52,0.04)] sm:p-8">
      ...
      <p className="mt-3 text-sm leading-relaxed text-[var(--muted)]">
        {cityLabel}에서 {keywordSuffix}을 찾을 때 상담·방문 동선을 고려해 함께 검색하는 인근 지하철역입니다.
      </p>
